...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--eval_sample_gen_txt_subset_flag", type=bool, default=True)
    parser.add_argument("--eval_sample_gen_txt_all_flag", type=bool, default=False)
    ...
    try:
        with wandb.init(project=args.wandb_project, config=vars(args), dir=args.project_output_dir) as run:
            ...
            trainer = PersuasionDPOTrainer(
                ...
                wandb_run=run,
                eval_sample_gen_txt_subset_flag=args.eval_sample_gen_txt_subset_flag,
                eval_sample_gen_txt_all_flag=args.eval_sample_gen_txt_all_flag,
