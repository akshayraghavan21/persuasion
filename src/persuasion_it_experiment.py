...
def parse_args() -> argparse.Namespace:
    ...
    ## Project Params
    parser.add_argument("--wandb_project", type=str, default='experiment_gaia_llama2-7b_it')
...
def train_instruction_tune(args: argparse.Namespace) -> float:
    """
    ...
    try:
        with wandb.init(project=args.wandb_project, config=vars(args), dir=args.project_output_dir) as run:
            ...
            trainer = SFTTrainer(
                ...
                packing=True,
                formatting_func=it_edit_dataset,
            )
...
if __name__ == "__main__":
    ...
    ## Train DPO
    final_eval_loss = train_instruction_tune(args)
